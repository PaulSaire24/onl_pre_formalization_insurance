...
public class MockBundleContext implements BundleContext,
	...
	public Bundle getBundle() {
		...
		Mockito.when(mockBundle.getSymbolicName()).thenReturn("RBVDR415IMPL-0.2.0-SNAPSHOT");
		Mockito.when(mockBundle.getVersion()).thenReturn(new Version("0.2.0-SNAPSHOT"));
		return mockBundle;
	}
